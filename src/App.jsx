...
const App = () => {
  ...
  return (
    <div className=" w-[80%] h-[90vh] mx-auto mt-10  ">
      <nav className=" flex justify-between  items-center h-[10%] ">
        <h1 className="text-4xl text-black font-black">W.</h1>
        <div className="md:flex gap-9 text-slate-500 hidden ">
        ...
        {isOpen ? (
          <div className="absolute top-0 right-0 w-[50vw] bg-white shadow-2xl h-[100vh] lg:hidden">
            <div
      ...
      <div className=" h-[450px] w-[100%] flex gap-[3%]">
        <div className=" h-[100%]  w-[71%] ">
          ...
          <div className=" flex  h-[43%] mt-[1%]">
            <div className="flex-1">
              <div className=" w-[90%]">
                <h1 className="text1 font-extrabold text-6xl">
            ...
            <div className=" flex-1 flex flex-col  justify-between">
              ...
              <div className="h-[50px] w-[200px] bg-[#F05D50]  flex items-center justify-center text-xl font-black cursor-pointer hover:opacity-80">
                Read More
              </div>
            </div>
          </div>
        </div>
        <div className=" side h-[100%] w-[26%]  bg-[#01011A] p-4 ">
      ...
      <div className=" footer h-[127px] flex justify-between gap-3 mt-6">
